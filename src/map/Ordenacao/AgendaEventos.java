...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, 5, 30), "Evento 4", "Atração 4");
        agendaEventos.adicionarEvento(LocalDate.of(2030, Month.JUNE, 1), "Evento 5", "Atração 5");
